...
class ParseRangeSpecTest(unittest.TestCase):
    ...
    def test_defaults_the_right_endpoint_to_head(self):
        self.assertEqual(parse_range_spec("abc123"), ("abc123", "HEAD", False))

    def test_defaults_an_open_ended_range_to_head(self):
        self.assertEqual(parse_range_spec("abc123.."), ("abc123", "HEAD", False))

    def test_rejects_a_missing_left_endpoint(self):
...
class BuildLastRangeTest(unittest.TestCase):
    ...
    def test_builds_a_range_for_the_most_recent_commit(self):
        self.assertEqual(build_last_range(1), ("HEAD~1", "HEAD"))

    def test_builds_a_range_for_several_commits(self):
...
class FormatDiffSpecTest(unittest.TestCase):
    ...
    def test_joins_the_endpoints_with_two_dots(self):
